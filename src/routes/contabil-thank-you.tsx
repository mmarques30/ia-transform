...
export const Route = createFileRoute("/contabil-thank-you")({
  ...
  head: () => ({
    meta: [
      { title: "Inscrição confirmada · IAplicada Contábil" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Inscrição confirmada · IAplicada Contábil" },
    ],
  }),
  component: ThankYouContabilPage,
});
...
function useFireLeadBackup(eid: string | undefined) {
  useEffect(() => {
    ...
    fbq(
      ...
      "Lead",
      {
        content_name: "contabil_diagnostic",
        content_category: "contabil",
      },
      { eventID: eid },
    );
