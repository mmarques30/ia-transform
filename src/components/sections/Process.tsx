...
const STEPS: Step[] = [
  {
    n: "1",
    title: "Você agenda o diagnóstico",
    text: "Conversa de 30 min, sem deck.",
    Icon: CalendarDays,
    Mockup: AgendaMockup,
  },
  {
    n: "2",
    title: "Mergulho na operação",
    text: "Processos, dados, pessoas e gargalos.",
    Icon: Search,
  ...
  },
  {
    ...
    text: "Operação integrada em um só lugar.",
