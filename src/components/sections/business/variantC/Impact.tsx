...
const METRICS: Metric[] = [
  { label: "Focus Fintax · horas liberadas", delta: "90h/mês", fill: 90, trend: "up", isGoodWhen: "up" },
  { label: "Focus Fintax · economia estimada", delta: "R$6,9k", fill: 92, trend: "up", isGoodWhen: "up" },
  { label: "PSA Consultores · relatório", delta: "4h/sem", fill: 80, trend: "down", isGoodWhen: "down" },
  { label: "PSA Consultores · economia", delta: "R$1,3k", fill: 60, trend: "up", isGoodWhen: "up" },
  { label: "CB Move · atendimentos", delta: "+300%", fill: 100, trend: "up", isGoodWhen: "up" },
  { label: "CB Move · custo de aquisição", delta: "−60%", fill: 40, trend: "down", isGoodWhen: "down" },
];
        ...
        <div className="text-center max-w-[760px] mx-auto">
          ...
          <Reveal delay={0.1}>
            <p className="mt-5 text-[16px] text-sage leading-[1.6] max-w-[600px] mx-auto">
              Três empresas. Três problemas diferentes. O mesmo método. Payback médio dos projetos
              entregues: 4,6 meses.
            </p>
          </Reveal>
        </div>
...
Antes vs. depois da automação
      ...
      >
        <span style={{ color: "oklch(0.5 0.015 115)" }}>
          Números reais · Focus Fintax, PSA Consultores, CB Move Neuroscience
        </span>
        <span
