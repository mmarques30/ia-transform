...
/**
 * Impact (LP-A / dobra 9) — painel 3 colunas, uma por case real
 * auditado. Substitui o antigo "monitor operacional" com barras
 * animadas que mostrava projeções da Focus Fintax por métricas
 * validadas de PSA, CB Move e Borges & Zembruski.
 *
 * Cada card traz 3-4 KPIs curtos + o cliente no topo. Rodapé do
 * painel deixa claro que é dado auditado.
 */
...
const CASES: CaseCard[] = [
  ...
  },
  {
    ...
    metrics: [
      { label: "Crescimento de pacientes", value: "30 → 100+" },
      { label: "Headcount admin extra", value: "R$0" },
      { label: "Processo de captação", value: "100% automatizado" },
    ],
  },
  {
    client: "Borges & Zembruski",
    metrics: [
      { label: "SDR humano", value: "substituído por IA" },
      { label: "Economia anual", value: "R$60k" },
      { label: "Pipeline sob gestão", value: "R$950k–R$1,9M" },
      { label: "CRM com processos ativos", value: "190" },
    ],
  },
];
        ...
        <div className="text-center max-w-[760px] mx-auto">
          ...
          <Reveal delay={0.1}>
            <p className="mt-5 text-[16px] text-sage leading-[1.6] max-w-[560px] mx-auto">
              Três empresas. Três problemas diferentes. O mesmo método.
            </p>
          </Reveal>
        </div>
