...
const METRICS: Metric[] = [
  { label: "Horas em fechamento mensal", delta: "−91%", fill: 9, trend: "down", isGoodWhen: "down" },
  { label: "Tempo de follow-up de lead", delta: "−100%", fill: 0, trend: "down", isGoodWhen: "down" },
  { label: "Horas em relatório executivo", delta: "−100%", fill: 0, trend: "down", isGoodWhen: "down" },
  { label: "Capacidade de atendimento", delta: "+300%", fill: 100, trend: "up", isGoodWhen: "up" },
  { label: "Custo operacional mensal", delta: "−R$6,9k", fill: 20, trend: "down", isGoodWhen: "down" },
  { label: "Automações rodando", delta: "+14", fill: 96, trend: "up", isGoodWhen: "up" },
];
        ...
        <div className="text-center max-w-[760px] mx-auto">
          ...
          <Reveal delay={0.05}>
            <h2 className="h-mix mt-6 text-[36px] sm:text-[44px] lg:text-[54px] text-foreground">
              Resultado medido em <em>economia real</em>,
...
Antes vs. depois da automação
      ...
      >
        <span style={{ color: "oklch(0.5 0.015 115)" }}>
          Calculado sobre o projeto Focus Fintax
        </span>
        <span
