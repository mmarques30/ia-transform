...
export function Problem() {
  ...
  useEffect(() => {
    ...
    // animação inteira pra que os elementos fiquem visíveis no estado
    // default. Sem isso o gsap.set(opacity: 0) deixaria tudo invisível.
  ...
  return (
    /* Mobile: section flui naturalmente (sem pin, sem overflow-hidden,
       sem sticky). O scroll-jacking funciona em desktop mas no mobile
       cortava os últimos cards porque 4 cards stacked excedem 100vh.
       Desktop mantém 200vh de pin spacer + sticky inner pro scrub do
       GSAP rolar a animação. */
