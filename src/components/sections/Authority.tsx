        ...
        <div className="grid lg:grid-cols-[5fr_7fr] gap-12 lg:gap-16 items-start">
            ...
            <div className="aspect-[4/5] w-full rounded-lg border border-border overflow-hidden bg-card relative">
              ...
              <div className="absolute inset-0 flex items-end p-6">
                <div>
                  ...
                  <p className="mt-1 text-foreground font-semibold text-lg">
                    Mariana Marques
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="mt-8 space-y-5 text-sage text-[17px] leading-[1.6]">
              <Reveal delay={0.1}>
                <p>
                  Fundei a IAplicada porque cansei de ver boas empresas presas
                  em pilotos de IA que nunca viraram operação. Há 3 anos, a
                  gente ajuda equipes a sair da experimentação e chegar na
                  implementação que sustenta.
                </p>
              </Reveal>
              <Reveal delay={0.15}>
                <p>
                  Atendemos empresas como Natura, Ambev, Magazine Luiza e
                  dezenas de médias em setores que vão de varejo a indústria. E
                  formei mais de 2.000 profissionais no Academy. Business é
                  onde aplicamos tudo isso na escala de quem precisa mudar a
                  operação inteira, não só a rotina pessoal.
                </p>
              </Reveal>
              <Reveal delay={0.2}>
                <p>
                  Não trabalho sozinha. Business é conduzido por um time de
                  especialistas em implementação, automação e liderança de IA,
                  curado e treinado por mim. Cada projeto é acompanhado de
                  ponta a ponta.
                </p>
              </Reveal>
            </div>
