            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border-4 overflow-hidden shadow-xl",
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href ? (
            <a
              ...
              onMouseEnter={(e) => (e.currentTarget.style.color = "var(--academy-cocoa)")}
